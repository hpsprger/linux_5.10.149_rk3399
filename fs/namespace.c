 ...
 */
static int __attribute__((optimize("O0"))) do_new_mount_fc(struct fs_context *fc, struct path *mountpoint,
 ...
 */
int __attribute__((optimize("O0")))  path_mount(const char *dev_name, struct path *path,
